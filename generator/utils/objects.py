...
class Object:
    ...
    def annotate(self, skip=False):
        ...
        if os.path.exists(path_annotation):
            if not skip:
                while annotate is None:
                    user_input = input("Prompt: An annotation file for this object exists. Overwrite? (y/n): ")
                    ...
                    if user_input.lower() == "y":
                        ...
                        print(f"Info: Unexpected input '{user_input}'!")
            else:
                annotate = False
